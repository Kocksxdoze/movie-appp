            ...
            <div className="bg-transparent rounded  py-5 px-7">
                <nav className="flex justify-between">
                    ...
                    <ul className="hidden md:flex flex-auto space-x-2">
                            ...
                            >
                                <Box display={"flex"} flexDir={"row"} alignItems={"center"} justifyContent={"center"} gap={2}>
                                    <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.48532 6.6038C8.74532 6.80395 8.74532 7.19605 8.48532 7.3962L0.804996 13.3085C0.476213 13.5616 0 13.3272 0 12.9123V1.08769C0 0.672767 0.476213 0.438385 0.804997 0.691484L8.48532 6.6038Z" fill="#E50914" />
                                    </svg>Home
                                </Box>
                        ...
                        <Link to={`/`} >
                            <Menu rightIcon={<ChevronDownIcon />}>
                                <MenuButton >
                                    <li
                                ...
                                <MenuList bg={"secondary"} border={"none"}>
                                    <MenuItem bg={"secondary"}>Download</MenuItem>
